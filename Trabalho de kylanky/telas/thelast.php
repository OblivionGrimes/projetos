...
<body class="body">
  ...
  <main class="bambam  ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagens/thelastof.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/thelastof.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/thelast.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">The Last Of Us Part I</h3>
      <br>
      <p class="para">Em uma civilização devastada, em que infectados e sobreviventes veteranos estão à solta, Joel, um protagonista abatido, é contratado para tirar uma garota de 14 anos, Ellie, de uma zona de quarentena militar.</p>
      
      <?php


      $ID_produto = 9; // ID do produto desejado
