...
<body class="body">
  ...
  <main class="bambam  ">
        ...
        <div class="carousel-inner" id="img-carroça">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="../imagens/bat.avif" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="../imagens/b.webp" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="../imagens/bbb.jpeg" class="d-block w-100" alt="...">
            </div>
          </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">Batman Arkhan Knight</h3>
      <br>
      <p class="para">Seja o Batman"": vivencie a experiência completa do Cavaleiro das Trevas no capítulo final da trilogia Arkham da Rocksteady. Os jogadores vão se tornar o Maior Detetive do Mundo de uma forma inédita.
      </p>

      <?php


      $ID_produto = 10; // ID do produto desejado
