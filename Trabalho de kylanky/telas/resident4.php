...
<body class="body">
  ...
  <main class="bambam  ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagens/resi-4-1-1024x576-1.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/resident evil.webp" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/redident.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">Resident Evil 4 Remake</h3>
      <br>
      <p class="para"> Seis anos se passaram desde o desastre biológico em Raccoon City.
        O agente Leon S. Kennedy, um dos sobreviventes do incidente, foi enviado para resgatar a filha raptada do presidente.
        Ele segue o rastro dela até uma isolada vila europeia.</p>
      
        <?php


      $ID_produto = 4; // ID do produto desejado
