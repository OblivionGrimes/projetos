...
<body class="body">
  ...
  <main class="bambam  ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagens/Metal-Gear-Solid-V-The-Phantom-Pain-main.webp" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/metalge.webp" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/metalgear.jpeg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">Metal Gear V: The Phanton Pain</h3>
      <br>
      <p class="para"> A Guerra Fria serve como pano de fundo e armas nucleares continuam a dar forma a uma crise global. Motivado por vingança, Snake estabelece um novo exército privado e retorna ao campo de batalha em busca do grupo clandestino, XOF.</p>
      
      <?php


      $ID_produto = 2; // ID do produto desejado
