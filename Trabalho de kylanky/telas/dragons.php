...
<body class="body">
  ...
  <main class="bambam  ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagens/dragons dogma.avif" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/drag.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/dragon.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">Dragon's Dogma Dark Arisen</h3>
      <br>
      <p class="para">  Escolha entre nove classes diferentes e embarque em sua própria aventura junto com três companheiros de IA, conhecidos como Pawns. Use o sistema de combate profundo para executar habilidades e magicks devastadoras enfrentando monstros lendários, ou escale-os para um ataque íntimo e pessoal!.</p>
      
      <?php


      $ID_produto = 5; // ID do produto desejado
