...
<body class="body">
  ...
  <main class="bambam  ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagens/shad.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/shadow o.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/shadow.avif" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">Shadow Of The Colossos</h3>
      <br>
      <p class="para"> SHADOW OF THE COLOSSUS é uma jornada espetacular por terras antigas em busca de feras gigantes. Armado com uma espada e um arco, explore os vastos terrenos e revele cada Colossus, cada um com um desafio único para testar sua inteligência, determinação e habilidade.</p>
      
      <?php


      $ID_produto = 1; // ID do produto desejado
