...
<body class="body">
  ...
  <main class="bambam  ">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../imagens/gggg.avif" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/gg.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../imagens/ggg.webp" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <article class="corroça col-3">
      <br>
      <h3 class="h-title">Grand Theft Auto VI</h3>
      <br>
      <p class="para">Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo  Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo Jogaçooo    </p>
      
      <?php


      $ID_produto = 12; // ID do produto desejado
